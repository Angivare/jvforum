  ...
  qs('.stage').innerHTML = `
    <div class="stage-sticker-container">
      ...
      <div class="stage-sticker-container__sticker">
        ...
        <img class="stage-sticker-hd sticker--pack-emoji" style="---width: 160px; ---height: 160px;" src="/assets/emoji/160/${image}">
      </div>
    </div>
  `
  ...
  qs('.stage').innerHTML = `
    <div class="stage-sticker-container">
      ...
      <div class="stage-sticker-container__sticker">
        ...
        <img class="stage-sticker-hd sticker--pack-${packId}" style="---width: 560px; ---height: 560px;" src="/assets/stickers/big/${id}">
      </div>
